...
int main() {
    ...
    // Inserting employees
    bst.root = bst.insert(bst.root, 10, "Khansa Noor", 20000);
    bst.root = bst.insert(bst.root, 50, "Fasiha Tariq",30000);
    bst.root = bst.insert(bst.root, 25, "Urba Naseem", 40000);
    bst.root = bst.insert(bst.root, 60, "Shiza Shahid",50000);
    bst.root = bst.insert(bst.root, 35, "Ayesha Fatima",60000);
